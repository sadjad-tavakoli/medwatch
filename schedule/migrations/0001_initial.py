    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('N', 'Requested'), ('A', 'Accepted'), ('R', 'Rejected')], default='N', max_length=1)),
                ('created', models.DateTimeField(default=datetime.datetime(2017, 1, 27, 14, 21, 32, 378571))),
